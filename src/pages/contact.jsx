          ...
          <Row className="justify-content-center">
            <Col lg={10} xl={8} className="text-center">
              ...
              <p className="contact-subtitle">
                Have questions or need assistance with your arbitrage journey? 
                Our dedicated support team is available around the clock to ensure 
                your trading experience remains seamless and secure.
              </p>
            </Col>
          </Row>
        </Container>
                  ...
                  <Form onSubmit={handleSubmit} className="premium-contact-form">
                    ...
                    <div className="form-action-area">
                      <Button
                        type="submit"
                        variant="success"
                        className={`submit-premium-btn ${isSubmitting ? "loading" : ""}`}
                        disabled={isSubmitting}
                      >
                        {isSubmitting ? (
                          <>
